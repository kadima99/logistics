...
public interface OutboundOrderMapper {
    ...
    @Update("UPDATE outbound_order set order_id = #{orderId},warehouse_id= #{warehouseId},next_warehouse_id = #{nextWarehouseId},del_mark = #{delMark},create_date = #{createDate} WHERE outbound_order_id = #{id}")
